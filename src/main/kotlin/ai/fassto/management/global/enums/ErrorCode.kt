...
enum class ErrorCode(
    ...
    UNPROCESSABLE_ENTITY(HttpStatus.UNPROCESSABLE_ENTITY, ErrorType.ERROR, "요청에 실패 하였습니다."),
    INTERNAL_SERVER_ERROR(HttpStatus.INTERNAL_SERVER_ERROR, ErrorType.ERROR, "오류가 발생 하였습니다. 관리자에 문의 바랍니다."),

    SAMPLE_NOT_FOUND(HttpStatus.UNPROCESSABLE_ENTITY, ErrorType.WARN, "Sample not found."),

    FILE_MANAGEMENT_SERVER_ERROR(HttpStatus.INTERNAL_SERVER_ERROR, ErrorType.WARN, "파일 관리 요청에 실패하였습니다."),
